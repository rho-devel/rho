expected <- "closure"
test(id=24472, code={
argv <- structure(list(x = function (file = ifelse(onefile, "Rplots.pdf", 
    "Rplot%03d.pdf"), width, height, onefile, family, title, 
    fonts, version, paper, encoding, bg, fg, pointsize, pagecentre, 
