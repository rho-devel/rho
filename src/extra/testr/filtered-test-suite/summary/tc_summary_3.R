expected <- structure(c("Min.   :4.300  ", "1st Qu.:5.100  ", "Median :5.800  ", 
"Mean   :5.843  ", "3rd Qu.:6.400  ", "Max.   :7.900  ", "Min.   :2.000  ", 
"1st Qu.:2.800  ", "Median :3.000  ", "Mean   :3.057  ", "3rd Qu.:3.300  ", 
"Max.   :4.400  ", "Min.   :1.000  ", "1st Qu.:1.600  ", "Median :4.350  ", 
"Mean   :3.758  ", "3rd Qu.:5.100  ", "Max.   :6.900  ", "Min.   :0.100  ", 
"1st Qu.:0.300  ", "Median :1.300  ", "Mean   :1.199  ", "3rd Qu.:1.800  ", 
"Max.   :2.500  ", "setosa    :50  ", "versicolor:50  ", "virginica :50  ", 
NA, NA, NA), .Dim = c(6L, 5L), .Dimnames = list(c("", "", "", 
"", "", ""), c(" Sepal.Length", " Sepal.Width", " Petal.Length", 
" Petal.Width", "      Species")), class = "table")
test(id=0, code={
argv <- structure(list(object = structure(list(Sepal.Length = c(5.1, 
