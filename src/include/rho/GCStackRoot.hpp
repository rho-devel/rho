 ...
 *
 * @brief Templated class rho::GCStackRoot and its untemplated utility class
 * rho::GCStackRootBase.
 */
...
namespace rho {
     ...
     * processor stack.
     *
     * Note that because rho does conservative stack scanning, use of
     ...
     * are implemented in rho via class ProtectStack.
     *
