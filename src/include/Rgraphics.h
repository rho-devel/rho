...
void GCircle(double, double, GUnit, double, int, int, pGEDev);
...
void GLine(double, double, double, double, GUnit, pGEDev);
/* Return the location of the next mouse click: */
Rboolean GLocator(double*, double*, GUnit, pGEDev);
...
void GPolygon(int, double*, double*, GUnit, int, int, pGEDev);
/* Draw series of straight lines using the specified lists of x and y values: */
void GPolyline(int, double*, double*, GUnit, pGEDev);
/* Draw a rectangle given two opposite corners: */
void GRect(double, double, double, double, GUnit, int, int, pGEDev);
...
void GArrow(double, double, double, double, GUnit, double, double, int, pGEDev);
...
void GSymbol(double, double, GUnit, int, pGEDev);
