...
{"(",		nullptr,	do_paren,	0,	1,	1,	{PP_PAREN,   PREC_FN,	  0}},
...
{"+",		nullptr,	do_arith, PLUSOP,	1,	2,	{PP_BINARY,  PREC_SUM,	  0}},
{"-",		nullptr,	do_arith, MINUSOP,1,	2,	{PP_BINARY,  PREC_SUM,	  0}},
{"*",		nullptr,	do_arith, TIMESOP,1,	2,	{PP_BINARY,  PREC_PROD,	  0}},
{"/",		nullptr,	do_arith, DIVOP,	1,	2,	{PP_BINARY2, PREC_PROD,	  0}},
{"^",		nullptr,	do_arith, POWOP,	1,	2,	{PP_BINARY2, PREC_POWER,  1}},
{"%%",		nullptr,	do_arith, MODOP,	1,	2,	{PP_BINARY2, PREC_PERCENT,0}},
{"%/%",		nullptr,	do_arith, IDIVOP,	1,	2,	{PP_BINARY2, PREC_PERCENT,0}},
{"%*%",		do_matprod,	nullptr,	0,	1,	2,	{PP_BINARY,  PREC_PERCENT,0}},

{"==",		nullptr,	do_relop, EQOP,	1,	2,	{PP_BINARY,  PREC_COMPARE,0}},
{"!=",		nullptr,	do_relop, NEOP,	1,	2,	{PP_BINARY,  PREC_COMPARE,0}},
{"<",		nullptr,	do_relop, LTOP,	1,	2,	{PP_BINARY,  PREC_COMPARE,0}},
{"<=",		nullptr,	do_relop, LEOP,	1,	2,	{PP_BINARY,  PREC_COMPARE,0}},
{">=",		nullptr,	do_relop, GEOP,	1,	2,	{PP_BINARY,  PREC_COMPARE,0}},
{">",		nullptr,	do_relop, GTOP,	1,	2,	{PP_BINARY,  PREC_COMPARE,0}},
