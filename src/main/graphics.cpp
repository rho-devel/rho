...
void GLine(double x1, double y1, double x2, double y2, GUnit coords, pGEDevDesc dd)
{
...
void GPolyline(int n, double *x, double *y, GUnit coords, pGEDevDesc dd)
{
    int i;
    double *xx;
    double *yy;
...
void GText(double x, double y, GUnit coords, const char *str, cetype_t enc,
...
void GSymbol(double x, double y, GUnit coords, int pch, pGEDevDesc dd)
{
